...
class TestSmokeTest():
  ...
  def test_1HomePageHeader(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1008, 830)
  ...
  def test_4JoinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Jhon")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Business Example Name")
